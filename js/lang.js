const arrLang = {
    'eng': {
        ...
        'popupFitnessDesc': '<p>The task was to lay out a landing page. Responsive was not required</p> <p>I used JQuery, SCSS, FLEX, GRID</p>',
    ...
    'ru': {
        ...
        'popupFitnessDesc': '<p>Задачей было сверстать лендинг. Адаптив не требовался</p> <p>В работе использовал JQuery, SCSS, FLEX, GRID</p>',
    },
};
